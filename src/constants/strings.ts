...
export const GAME_TITLE = strings.GAME_TITLE
export const WIN_MESSAGES = strings.WIN_MESSAGES
export const GAME_COPIED_MESSAGE = strings.GAME_COPIED_MESSAGE
export const NOT_ENOUGH_LETTERS_MESSAGE = strings.NOT_ENOUGH_LETTERS_MESSAGE
...
export const ENTER_TEXT = strings.ENTER_TEXT
export const DELETE_TEXT = strings.DELETE_TEXT
export const STATISTICS_TITLE = strings.STATISTICS_TITLE
export const GUESS_DISTRIBUTION_TEXT = strings.GUESS_DISTRIBUTION_TEXT
export const NEW_WORD_TEXT = strings.NEW_WORD_TEXT
export const SHARE_TEXT = strings.SHARE_TEXT
export const SHARE_FAILURE_TEXT = strings.SHARE_FAILURE_TEXT
export const TOTAL_TRIES_TEXT = strings.TOTAL_TRIES_TEXT
