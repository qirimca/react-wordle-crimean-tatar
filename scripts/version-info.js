...
// Перевіряємо, чи запущено в CI (повністю пропускаємо в GitHub Actions)
if (process.env.GITHUB_ACTIONS) {
  console.log('ℹ️ Running in GitHub Actions, version info handled by workflow environment variables');
  process.exit(0);
}
